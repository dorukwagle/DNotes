...
native-image -jar target\DNotes-1.0.0.jar ^
  ...
  -H:+AddAllCharsets ^
  -H:EnableURLProtocols=http,https ^
  -H:IncludeResources=".*\.css|.*\.png|.*\.ttf|.*\.fxml|org/sqlite/native/Windows/x86_64/sqlitejdbc.dll" ^
  -cp "%USERPROFILE%\.m2\repository\org\xerial\sqlite-jdbc\3.50.2.0\sqlite-jdbc-3.50.2.0.jar"
